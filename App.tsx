      ...
      <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-gray-200 dark:border-slate-800 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button onClick={handleExportJSON} className="w-10 h-10 rounded-xl flex items-center justify-center transition-all bg-sky-100 text-sky-600 hover:bg-sky-500 hover:text-white dark:bg-slate-800" title="Exporter la configuration (JSON)">
          ...
          <button onClick={() => setIsDarkMode(!isDarkMode)} className="w-10 h-10 flex items-center justify-center rounded-xl bg-gray-100 dark:bg-slate-800 text-gray-500">
