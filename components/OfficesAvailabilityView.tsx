        ...
        <div className="flex bg-gray-100 dark:bg-slate-800 p-1.5 rounded-xl">
          {DAYS.map((day) => (
            <button
              ...
              className={`px-6 py-2.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${selectedDay === day ? "bg-sky-500 text-white shadow-lg" : "text-gray-400"}`}
            >
              {day}
            </button>
          ))}
                      ...
                      {isOccupied ? (
                          ...
                          <div className="relative flex-shrink-0">
                            <div className="w-16 h-16 rounded-xl overflow-hidden border-2 border-sky-400/50 shadow-sm">
                              {!imageErrors[occupant.id] ? (
                                ...
                                <div
                                  className={`w-full h-full flex items-center justify-center text-lg font-black text-white ${getRoleColor(occupant.role)}`}
                                >
                            ...
                            <div
                              className={`absolute -bottom-1 -right-1 w-5 h-5 rounded-full border-2 border-white dark:border-slate-700 ${getRoleColor(occupant.role)} shadow-sm`}
                            ></div>
                          </div>
                        ...
                        <>
                          <div className="w-16 h-16 bg-gray-100 dark:bg-slate-800 flex items-center justify-center text-gray-300 rounded-xl">
                            <i
                              className={`fa-solid ${isEditable ? "fa-plus" : "fa-ban"} text-sm`}
                            ></i>
                          </div>
                    ...
                    <div className="relative flex-shrink-0">
                      <div className="w-12 h-12 rounded-xl overflow-hidden border-2 border-sky-400 shadow-sm transition-transform group-hover:scale-110">
                        {!imageErrors[member.id] ? (
                          ...
                          <div
                            className={`w-full h-full flex items-center justify-center text-xs font-black text-white ${getRoleColor(member.role)}`}
                          >
                      ...
                      <div
                        className={`absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full border-2 border-white dark:border-slate-700 ${getRoleColor(member.role)} shadow-sm`}
                      ></div>
                    </div>
